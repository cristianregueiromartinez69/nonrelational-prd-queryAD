package com.cristianProyectoAD.nonrelational_prd_query.registrolibros.dto;
...
public class LibroRegistroDTO {
     ...
     */
    public LibroRegistroDTO(String isbn, String autor, String nombre, LocalDate fechaLectura, LocalDate fechaRegistro) {
        this.isbn = isbn;
        this.autor = autor;
        this.nombre = nombre;
